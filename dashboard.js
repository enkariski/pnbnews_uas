$(document).ready(function() {
    const data = {
        ...
        questions: 20,
        news: [
            { id: 1, title: "Berita Akademik 1", content: "Isi berita akademik 1", category: "akademik", image: "https://via.placeholder.com/300x200" },
        ...
        comments: [
            { id: 1, newsId: 1, user: "riski", comment: "Anjay Juara Satu, Keren buanggettt PNB !!!!", reply: "" },
            { id: 2, newsId: 2, user: "User2", comment: "Komentar untuk berita non-akademik 1", reply: "" },
            { id: 3, newsId: 3, user: "User3", comment: "Komentar untuk berita olahraga 1", reply: "" }
        ]
    };
    ...
    $('#editNewsSelect').on('change', function() {
        ...
        if (selectedNews) {
            ...
            $('#editPreviewImage').text(selectedNews.image);
    ...
    $('#editNewsTitle, #editNewsContent, input[name="editNewsCategory"], #editNewsImage').on('input change', function() {
        ...
        $('#editPreviewImage').text($('#editNewsImage').val());
