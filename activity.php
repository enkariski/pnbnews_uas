                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title">51 MAHASISWA BERPRESTASI PNB MENDAPATKAN PENGHARGAAN/APRESIASI</h5>
                                ...
                                <i style="margin-left:20px;" class="fa-solid fa-comment"></i> Comments Off
                                <br><br>
                        <p class="card-text">51 mahasiswa PNB yang mendapatkan penghargaan merupakan mahasiswa Politeknik Negeri Bali (PNB) yang berhasil meraih prestasi sepanjang tahun 2021. Mereka hadir di Gedung Widya Guna, Senin, 27 Desember 2021, untuk menerima penghargaan yang diberikan PNB sebagai reward telah menorehkan prestasi tingkat nasional maupun internasional.</p>
                        <a href="#" class="btn btn-primary">Lihat Selengkapnya</a>
                    </div>
                </div>
            </div>
